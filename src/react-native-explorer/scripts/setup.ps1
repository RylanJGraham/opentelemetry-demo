...
if (-not $adb) {
    Write-Host "⚠️  adb not found in PATH. Make sure Android SDK Platform Tools are installed." -ForegroundColor Yellow
    ...
    if ($devices) {
        ...
        Write-Host "  ⚠️  No Android emulator running. Start one before running the agent." -ForegroundColor Yellow
    }
}
